...
--Q10. How does the current month’s revenue compare to the previous month’s revenue?using LAG)
...
--Q13. Which publisher has the highest total sales?
SELECT 
    p.Publication,
...
--Q14. What is the total revenue generated for each book after applying discounts, along with details such as sales date, publisher, and stock status?
SELECT 
    d.Sales_Date,
